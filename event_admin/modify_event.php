...
<div style="padding-left:30%">
	<div class="row">
    	<div class="input-field col s6">
    		<label for="name" style="min-width:240px;">Name</label><br>
    ...
    <div class="row">
    	<div class="input-field col s6">
    		<label for="purpose" style="min-width:240px;">Purpose</label><br>
    		<input type="text" id="purpose" value='<?php echo $purpose;?>' style="min-width:240px;" required>
    	</div>
    </div>
    <div class="row">
    	<div class="input-field col s6">
    		<label for="details" style="min-width:240px;">Details</label><br>
